...
export default function Footer() {
  return (
    <footer className="py-6 mt-10 border-t border-gray-200 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900 text-gray-700 dark:text-white">
